                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select @error('employee_id') is-invalid @enderror"
                                                        ...
                                                        @foreach ($employee as $row)
                                                            <option value="{{ $row->id }}"
                                                                {{ old('employee_id') == $row->id ? 'selected' : '' }}>
                                                    ...
                                                    <select class="form-select @error('injurie_id') is-invalid @enderror"
                                                        ...
                                                        @foreach ($injuryType as $injury)
                                                            <option value="{{ $injury->id }}"
                                                                {{ old('injurie_id') == $injury->id ? 'selected' : '' }}>
                                                                {{ $injury->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <select class="form-select @error('diagnose_id') is-invalid @enderror"
                                                        ...
                                                        @foreach ($diagnosis as $diag)
                                                            <option value="{{ $diag->id }}"
                                                                {{ old('diagnose_id') == $diag->id ? 'selected' : '' }}>
                                                                {{ $diag->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select @error('staffType') is-invalid @enderror"
                                                        ...
                                                        <option value="Staff"
                                                            {{ old('staffType') == 'Staff' ? 'selected' : '' }}>Staff
                                                        </option>
                                                        <option value="Family"
                                                            {{ old('staffType') == 'Family' ? 'selected' : '' }}>Family
                                                        </option>
                                                    </select>
                                                </div>
                                                @error('staffType')
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select @error('referral') is-invalid @enderror"
                                                        ...
                                                        <option value="No Referral"
                                                            {{ old('referral') == 'No Referral' ? 'selected' : '' }}>No
                                                            Referral</option>
                                                        <option value="Fourou"
                                                            {{ old('referral') == 'Fourou' ? 'selected' : '' }}>Fourou
                                                        </option>
                                                        <option value="Kadiolo"
                                                            {{ old('referral') == 'Kadiolo' ? 'selected' : '' }}>Kadiolo
                                                        </option>
                                                        <option value="Sikasso"
                                                            {{ old('referral') == 'Sikasso' ? 'selected' : '' }}>Sikasso
                                                        </option>
                                                        <option value="INPS"
                                                            {{ old('referral') == 'INPS' ? 'selected' : '' }}>INPS</option>
                                                    </select>
                                                </div>
                                                @error('referral')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control @error('history') is-invalid @enderror" name="history" id="history">{{ old('history') }}</textarea>
                                                </div>
                                                @error('history')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control @error('observation') is-invalid @enderror" name="observation" id="observation">{{ old('observation') }}</textarea>
                                                </div>
                                                @error('observation')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control @error('comments') is-invalid @enderror" name="comments" id="comments">{{ old('comments') }}</textarea>
                                                </div>
                                                @error('comments')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[hemoglobin]"
                                                        ...
                                                        <option value="normal"
                                                            {{ old('laboratory.hemoglobin') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                                            {{ old('laboratory.hemoglobin') == 'abnormal' ? 'selected' : '' }}>
                                                            Abnormal</option>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[malariaThick]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.malariaThick') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[malariaThin]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.malariaThin') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[bloodGlucose]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.bloodGlucose') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[got]" id="got">
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.got') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                                            {{ old('laboratory.got') == 'abnormal' ? 'selected' : '' }}>
                                                            Abnormal</option>
                                                        <option value="undetermined"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[gpt]" id="gpt">
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.gpt') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                                            {{ old('laboratory.gpt') == 'abnormal' ? 'selected' : '' }}>
                                                            Abnormal</option>
                                                        <option value="undetermined"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[ggt]" id="ggt">
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.ggt') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                                            {{ old('laboratory.ggt') == 'abnormal' ? 'selected' : '' }}>
                                                            Abnormal</option>
                                                        <option value="undetermined"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[creatinine]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.creatinine') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                                            {{ old('laboratory.creatinine') == 'abnormal' ? 'selected' : '' }}>
                                                            Abnormal</option>
                                                        <option value="undetermined"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[urea]" id="urea">
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.urea') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                                            {{ old('laboratory.urea') == 'abnormal' ? 'selected' : '' }}>
                                                            Abnormal</option>
                                                        <option value="undetermined"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[potassiumK]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.potassiumK') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                                            {{ old('laboratory.potassiumK') == 'abnormal' ? 'selected' : '' }}>
                                                            Abnormal</option>
                                                        <option value="undetermined"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[uricAcid]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.uricAcid') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                                            {{ old('laboratory.uricAcid') == 'abnormal' ? 'selected' : '' }}>
                                                            Abnormal</option>
                                                        <option value="undetermined"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[troponinT]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.troponinT') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                                            {{ old('laboratory.troponinT') == 'abnormal' ? 'selected' : '' }}>
                                                            Abnormal</option>
                                                        <option value="undetermined"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[urineDipstick]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.urineDipstick') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[gammaGt]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.gammaGt') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                                            {{ old('laboratory.gammaGt') == 'abnormal' ? 'selected' : '' }}>
                                                            Abnormal</option>
                                                        <option value="undetermined"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[cholesterol]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.cholesterol') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[total]" id="total">
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.total') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                                            {{ old('laboratory.total') == 'abnormal' ? 'selected' : '' }}>
                                                            Abnormal</option>
                                                        <option value="undetermined"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[ldl]" id="ldl">
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.ldl') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                                            {{ old('laboratory.ldl') == 'abnormal' ? 'selected' : '' }}>
                                                            Abnormal</option>
                                                        <option value="undetermined"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[triglycerides]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.triglycerides') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[tBilirubine]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.tBilirubine') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[dBilirubine]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.dBilirubine') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[iBilirubine]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.iBilirubine') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-select" name="laboratory[fastingGlucose]"
                                                        ...
                                                        <option value="">Select Status</option>
                                                        <option value="normal"
                                                            {{ old('laboratory.fastingGlucose') == 'normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="abnormal"
