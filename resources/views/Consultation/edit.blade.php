        ...
        <form class="row" action="{{ route('consultation.update', $consultation->id) }}" method="POST">
            ...
            <div class="col-md-6">
                ...
                <textarea class="form-control" name="diagnosis" id="diagnosis"
                    rows="6">{{ $consultation->diagnosis }}</textarea>
                @error('diagnosis')
                <div class="alert-danger alert">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="bp" id="bp" value="{{ $consultation->bp }}">
                @error('bp')
                <div class="alert-danger alert">{{ $message }}</div>
                @enderror
            </div>
            <div class="col-md-6">
                ...
                <input type="number" class="form-control" name="pulse" id="pulse" value="{{ $consultation->pulse }}">
            ...
            <div class="col-md-6">
                ...
                <textarea class="form-control" name="observation" id="observation"
                    rows="6">{{ $consultation->observation }}</textarea>
                @error('observation')
                <div class="alert-danger alert">{{ $message }}</div>
                @enderror
            </div>
            <div class="col-md-6">
                ...
                <textarea class="form-control" name="comments" id="comments"
                    rows="6">{{ $consultation->comments }}</textarea>
                @error('comments')
                <div class="alert-danger alert">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-6">
                ...
                <select class="form-select" name="diagnosiMali" id="diagnosiMali">
                    ...
                    <option value="diagnosiMali1" @selected($consultation->diagnosiMali ===
                        'diagnosiMali1')>DiagnosiMali1</option>
                    <option value="diagnosiMali2" @selected($consultation->diagnosiMali ===
