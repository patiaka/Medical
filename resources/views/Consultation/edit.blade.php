            ...
            <form class="row" action="{{ route('consultation.update', $consultation->id) }}" method="POST">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="referral" id="referral">
                        ...
                        <option @selected($consultation->referral === 'no referral') value="no referral">No referral</option>
                    </select>
                    @error('referral')
                        <div class="alert-danger alert">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="diagnosispec" id="diagnosispec">
                        <option value="diagnosispec1" @selected($consultation->diagnosispec === 'diagnosispec1')>Diagnosispec1</option>
                        <option value="diagnosispec2" @selected($consultation->diagnosispec === 'diagnosispec2')>Diagnosispec2</option>
                    </select>
                    @error('diagnosispec')
                        <div class="alert-danger alert">{{ $message }}</div>
                    @enderror
