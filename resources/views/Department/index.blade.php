                                    ...
                                    <tr>
                                        ...
                                        <td class="cell"><a class="btn-sm app-btn-secondary"
                                            ...
                                            <a class="btn-sm app-btn-danger"
                                                href="{{ route('department.delete', $department->id) }}"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
@section('scripts')
    <script>
        document.getElementById('search-form').addEventListener('submit', function(event) {
            ...
            let searchValue = document.getElementById('search-orders').value;

            fetch('{{ route('department.search') }}?q=' + searchValue)
                .then(response => response.json())
                .then(data => {

                    let tableBody = document.querySelector('.app-table-hover tbody');
                    tableBody.innerHTML = '';
                    ...
                    <tr>
                        ...
                        <td class="cell"><span class="truncate">${department.name}</span></td>
                        <td class="cell">
                            <a class="btn-sm app-btn-secondary" href="/department/edit/${department.id}">
                                <!-- Votre bouton d'édition -->
                            </a>
                            <a class="btn-sm app-btn-danger" href="/department/${department.id}">
