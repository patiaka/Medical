...
<ul class="nav nav-tabs orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4" id="myTab"
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="annual-leave-tab" data-bs-toggle="tab" data-bs-target="#annual-leave" type="button"
            role="tab" aria-controls="annual-leave" aria-selected="false">Annual Leave</button>
    </li>
</ul>
