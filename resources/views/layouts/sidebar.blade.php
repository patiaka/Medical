<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="/"><img class="logo-icon me-2" src="{{ asset('assets/images/Resolute.png') }}"
                    ...
                    <div id="submenu-settings" class="collapse submenu submenu-settings"
                        ...
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item">
                                <a class="submenu-link {{ request()->routeIs('journal.index') ? 'active' : '' }}"
                                    href="{{ route('diagnosis.index') }}">Activities</a>
                            </li>
                            <li class="submenu-item">
                            ...
                            <li class="submenu-item">
                                <a class="submenu-link {{ request()->routeIs('drugname.index') ? 'active' : '' }}"
                                    href="{{ route('drugname.index') }}">drugname</a>
                            </li>
                        </ul>
                    </div>
                </li>
