                ...
                @if (Auth::user()->isAdmin())
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link {{ request()->routeIs('consultation.index') ? 'active' : '' }} "
                            ...
                            <span class="nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    fill="currentColor" class="bi bi-file-medical" viewBox="0 0 16 16">
                                    <path
                    ...
                    {{-- <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link {{ request()->routeIs('healthSurveillance.followUpList') ? 'active' : '' }}"
                        href="{{ route('healthSurveillance.followUpList') }}">
                        <span class="nav-icon">
                    ...
                    <li class="nav-item has-submenu">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link submenu-toggle no-loading" href="" data-bs-toggle="collapse"
                    ...
                    <li class="nav-item has-submenu">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link submenu-toggle no-loading" href="" data-bs-toggle="collapse"
                            data-bs-target="#submenu-settings" aria-expanded="false"
                        ...
                        <div id="submenu-settings" class="collapse submenu submenu-settings"
                            ...
                            <ul class="submenu-list list-unstyled">
                                ...
                                <li class="submenu-item">
                                    <a class="submenu-link {{ request()->routeIs('medication.index') ? 'active' : '' }}"
                                        href="{{ route('medication.index') }}">Medication</a>
                                </li>
                            </ul>
                        </div>
                    </li>
